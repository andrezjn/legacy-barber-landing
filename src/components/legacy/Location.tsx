      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-20 flex flex-col items-center text-center">
          ...
          <h2 className="mt-4 max-w-2xl font-display text-4xl md:text-5xl lg:text-6xl">
            Find us in <span className="text-gradient-gold italic">São Paulo.</span>
          </h2>
          ...
          <div className="col-span-2 flex flex-col gap-6">
            <div className="rounded-2xl border border-border bg-card p-8">
              <div className="flex items-center gap-3 text-gold">
                <MapPin size={18} />
                <span className="text-[10px] uppercase tracking-luxury">Address</span>
              </div>
            ...
            <div className="rounded-2xl border border-border bg-card p-8">
              <div className="flex items-center gap-3 text-gold">
                <Clock size={18} />
                <span className="text-[10px] uppercase tracking-luxury">Hours</span>
              </div>
