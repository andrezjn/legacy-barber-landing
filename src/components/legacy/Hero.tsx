      ...
      <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-center px-6">
        <div className="reveal max-w-3xl">
          ...
          <h1 className="font-display text-5xl leading-[1.05] text-foreground sm:text-6xl md:text-7xl lg:text-8xl">
            Seu estilo começa
            <br />
            na <span className="text-gradient-gold italic">cadeira certa.</span>
          </h1>
          <p className="mt-8 max-w-xl text-base leading-relaxed text-muted-foreground md:text-lg">
            Cortes premium, experiência refinada e identidade masculina moderna —
            assinados por mestres barbeiros no coração de São Paulo.
          </p>
